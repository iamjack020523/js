class world extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio('worldMusic','assets/intro.mp3')
  ...
  create() {
    ...
    this.worldMusic = this.sound.add('worldMusic').setVolume(0.3)
    window.music2 = this.worldMusic
    window.music2.play();
    window.music2.loop = true;
  ...
  update() {
    ...
    if ( this.player.x > 745 && this.player.x < 755
      && this.player.y > 683 && this.player.y < 692 &&window.keys < 2) {
      window.music2.stop();
      this.room1()
      }
    ...
    else if ( this.player.x > 745 && this.player.x < 755
     && this.player.y > 683 && this.player.y < 692 && window.keys >= 15) {
       this.gameClear()
     }
